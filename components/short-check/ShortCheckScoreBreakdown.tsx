...
export default function ShortCheckScoreBreakdown({
  ...
  // Items in the specified order
  const items = [
    { label: "Droppiness", value: breakdown.droppiness, max: 12, min: -8, actualValue: breakdown.actualValues?.droppiness },
  ...
  return (
    <Card className="p-4 bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700 rounded-xl">
      ...
      <div className={`${isExpanded ? 'mt-4 pt-4 border-t border-gray-200 dark:border-gray-700' : 'mt-0'} text-right`}>
